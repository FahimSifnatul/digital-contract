...
$(document).ready(function(){
	...
	$("#form_sign_up").on('submit', function(e){
		...
		$("#form_sign_up_error_parent").empty();
		$("#form_sign_up_error_parent").append("<div id='form_sign_up_error' \
			class='form-control-text alert alert-danger alert-dismissible' style='display: none;'>\
                  </div>");
